...
const PokemonCard: React.FC<Props> = ({ pokemon }) => {
  ...
  const toggleExpand = async () => {
    ...
    await controls.start({ scale: isExpanded ? 1 : 1.5 });
  };
  ...
  return (
    <div className="flex items-center justify-center flex-col relative">
      ...
      >
        <motion.div
          className="bg-blue-500 flex items-center rounded-md p-1 relative"
          initial={{ scale: 1 }}
        ...
        >
          ...
          {isExpanded && (
            <div className="absolute w-[220px] h-[220px] bg-red-300 rounded-lg flex items-center justify-center">
